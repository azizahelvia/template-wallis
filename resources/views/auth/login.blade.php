...
<head>
    ...
    <title>Selamat Datang Di Wallis - E-wallet Sekolah</title>
                            ...
                            <div class="col-lg-6 mb-5">
                                <div class="p-5 mb-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">{{ __('Wallis') }}</h1>
                                    </div>
                                    <form method="POST" action="{{ route('login') }}" class="user">
                                        @csrf
                                        <div class="form-group">
                                            <input id="exampleInputEmail" type="email" class="form-control form-control form-control-user 
                                        ...
                                        <button type="submit" class="btn btn-success btn-user btn-block mt-5 mb-5">
                                            {{ __('Login') }}
                                        </button>
                                    </form>
                                </div>
